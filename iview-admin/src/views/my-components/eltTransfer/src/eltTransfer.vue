<template>
  <div class="transfer">
    <div class="transfer-panel">
      ...
      <div v-if="showQuery">
        <el-form :inline="true" :model="leftQueryCondition" class="query-form">
          ...
          <el-form-item>
            <el-button size="mini" type="primary" @click="onLeftQuerySubmit()">{{queryTexts[0]}}</el-button>
          </el-form-item>
        </el-form>
      </div>
      <el-table
    ...
    <div class="transfer-panel">
      ...
      <div v-if="showQuery" class="div-height">
...
<!-- <style scoped> 代码中使用scoped之后，保证各文件中的css不相互影响，给每个component都做了唯一的标记。会将代码样式编译成 div[data-v-f3f3eg9] -->
<style>
  .transfer {
    font-size: 14px;
    display: flex;
